  ...
  constructor(game: Game) {
    ...
    game.ui.innerHTML = `
      <div style="position:absolute;inset:0;background:linear-gradient(160deg,#0a0020,#0a2010,#101808);display:flex;flex-direction:column;">
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:12px 16px;flex-shrink:0;pointer-events:all;position:relative;">
          ...
          <!-- Rules panel -->
          <div id="arcadeRulesPanel" style="display:none;position:absolute;top:52px;right:0px;z-index:30;
            ...
            <div id="arcadeRulesPanelContent"></div>
            <button id="closeArcadeRules" style="margin-top:8px;width:100%;
      ...
      ">
        ...
        <div style="display:flex;flex-direction:column;gap:16px;width:100%;max-width:360px;padding-bottom:8px;">
          ...
          <!-- Duck Life -->
          <button id="duckLifeBtn" style="
            background:linear-gradient(135deg,rgba(10,60,80,0.9),rgba(20,120,160,0.7));
            border:2px solid rgba(100,200,255,0.6);border-radius:20px;
            padding:20px 24px;cursor:pointer;text-align:left;
            display:flex;align-items:center;gap:16px;
          ">
            <div style="font-size:40px;flex-shrink:0;">🦆</div>
            <div>
              <div style="color:white;font-size:18px;font-weight:bold;margin-bottom:4px;">Duck Life</div>
              <div style="color:rgba(255,255,255,0.6);font-size:13px;">Train your duck and race to victory!</div>
              <div style="color:#FFD700;font-size:12px;margin-top:4px;">🏃 Run • 🪶 Fly • 🏊 Swim • 🏁 Race</div>
            </div>
          </button>
          ...
          ">
            ...
            <div>
              ...
              <div style="color:rgba(255,255,255,0.6);font-size:13px;">Click 12 times in 1.3 seconds!</div>
    ...
    document.getElementById("arcadeRulesBtn")!.onclick = () => {
      ...
      if (p.style.display === "none") {
        document.getElementById("arcadeRulesPanelContent")!.innerHTML = rulesHTML(game.state.username || "anonymous");
        bindReportButtons(game.state.username || "anonymous");
